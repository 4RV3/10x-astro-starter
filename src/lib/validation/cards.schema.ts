...
export const listCardsQuerySchema = z.object({
  ...
  sort: z
    .string()
    .optional()
    .refine((v) => v == null || ["created_at_asc", "created_at_desc", "due_at_asc"].includes(v), {
      message: "Invalid sort",
    }),
  origin: z
    .string()
    .optional()
    .refine((v) => v == null || ["manual", "ai"].includes(v), {
...
export const updateCardCommandSchema = z
  ...
  .refine((obj) => [obj.front, obj.back, obj.source_snippet].every((v) => v == null || v.length > 0), {
